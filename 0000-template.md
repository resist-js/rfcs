...
> There are a lot of ways resist.js is used. It's hosted on different platforms;
> integrated with different libraries; built with different bundlers, etc. No one
> person knows everything about all the ways resist.js is used. What does someone who
> knows about resist.js but hasn't necessarily used anything outside of it need to
...
> designs or make them better fit resist.js.
...
> idea best presented? As a continuation of existing resist.js patterns, or as a
> wholly new one?

> Would the acceptance of this proposal mean the resist.js guides must be
> re-organized or altered? Does it change how resist.js is taught to new users
> at any level?

> How should this feature be introduced and taught to existing resist.js
> users?

## Drawbacks

> Why should we _not_ do this? Please consider the impact on teaching resist.js,
